...
<AffiliateProductGrid
  heading="Shop The Budget Diwali Look"
  caption="Three simple, cost-effective pieces to make your home glow and smell like the festival of lights without overspending."
  products={[
  {
    name: "Flameless flickering LED Clay Diyas (Pack of 12)",
    brand: "Homemory",
    description: "Battery-operated warm amber LED lights wrapped in detailed traditional terracotta-style clay frames — safe for kids, pets, and renters.",
    image: "/layered-lighting-living-room.webp",
    imageAlt: "A set of flickering warm LED diyas lined up on a windowsill",
    price: { amount: 19.99, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CDIWALILEDDIYAS?tag=bigelow-20",
    network: "amazon",
    badge: "Rental Safe",
  },
  {
    name: "Artificial Marigold Flower Garlands (5-Pack)",
    brand: "Decozen",
    description: "Vibrant yellow and orange artificial marigold garlands. Perfect for hanging on your door frame or styling your Diwali home temple.",
    image: "/mindful-entryway.webp",
    imageAlt: "Vibrant orange artificial marigold garlands hanging along a doorway",
    price: { amount: 14.99, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CMARIGOLDGAR?tag=bigelow-20",
    network: "amazon",
  },
  {
    name: "Warm White Copper Wire Fairy Lights (2-Pack)",
    brand: "Minetom",
    description: "USB-powered warm white string fairy lights with remote control, perfect for achieving that cozy low-glow background illumination.",
    image: "/layered-lighting-living-room.webp",
    imageAlt: "Delicate warm white fairy lights styled inside a glass jar",
    price: { amount: 12.99, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CFAIRYLIGHTS?tag=bigelow-20",
    network: "amazon",
    badge: "Editor's Pick",
  }
  ]}
