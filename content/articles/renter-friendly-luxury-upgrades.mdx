...
<ShopTheLook>
  <ProductCard 
    title="Solid Unlacquered Brass Cabinet Pulls" 
    price="$45" 
    link="https://amazon.com/dp/placeholder?tag=bigelow-20" 
    image="/placeholder-brass-pulls.jpg" 
  />
  <ProductCard 
    title="Textured Peel-and-Stick Grasscloth" 
    price="$60" 
    link="https://amazon.com/dp/placeholder?tag=bigelow-20" 
    image="/placeholder-grasscloth.jpg" 
  />
  <ProductCard 
    title="Plug-in Brass Wall Sconce" 
    price="$110" 
    link="https://amazon.com/dp/placeholder?tag=bigelow-20" 
    image="/placeholder-sconce.jpg" 
  />
</ShopTheLook>
