...
<AffiliateProductGrid
  heading="Shop The Dark & Moody Edit"
  caption="Three pieces to abandon 'light and bright' and lean fully into jewel-box opulence."
  products={[
  {
    name: "Deep Botanical Wallpaper (Double Roll)",
    brand: "House of Hackney",
    description: "Dense, theatrical hand-printed botanicals on charcoal ground — covers an average powder room with one roll to spare.",
    image: "/luxury-powder-room.webp",
    imageAlt: "A double roll of deep botanical wallpaper on charcoal ground",
    price: { amount: 295, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CDARKWALLPAPER?tag=bigelow-20",
    network: "amazon",
    badge: "Editor's Pick",
  },
  {
    name: "Brass Sconce (Pair, Wall-Mounted)",
    brand: "Schoolhouse",
    description: "Eye-level brass sconces with milk glass shades — the only flattering light source in a powder room.",
    image: "/brass-faucet-detail.webp",
    imageAlt: "A pair of wall-mounted brass sconces with milk glass shades",
    price: { amount: 398, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CBRASSSCONCE?tag=bigelow-20",
    network: "amazon",
  },
  {
    name: "Antique Brass Statement Mirror",
    brand: "Rejuvenation",
    description: "Hand-finished brass with a softened arch — the single decorative move that completes a dark powder room.",
    image: "/bathroom-luxury-hero.webp",
    imageAlt: "An antique brass arched statement mirror",
    price: { amount: 549, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CARCHMIRROR?tag=bigelow-20",
    network: "amazon",
  }
  ]}
/>
