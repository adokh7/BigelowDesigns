...
image: "/pastel-maximalist-living-room.webp"
heroImage: "/pastel-maximalist-living-room.webp"
...
<div className="max-w-md mx-auto my-10 rounded-2xl overflow-hidden shadow-xl">
  <Image
    src="/pastel-maximalist-living-room.webp"
...
<div className="max-w-md mx-auto my-10 rounded-2xl overflow-hidden shadow-xl">
  <Image
    src="/cozy-eclectic-tv-lounge.webp"
...
<div className="max-w-md mx-auto my-10 rounded-2xl overflow-hidden shadow-xl">
  <Image
    src="/dopamine-decor-colorful-bedroom.webp"
...
<div className="max-w-md mx-auto my-10 rounded-2xl overflow-hidden shadow-xl">
  <Image
    src="/vintage-eclectic-bedroom.webp"
