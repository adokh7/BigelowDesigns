...
<div className="my-8 rounded-lg overflow-hidden shadow-lg"><Image src="/SwitchBot-Smart-Lock-Pro.webp" alt="SwitchBot Smart Lock Premium Home Integration" width={1200} height={675} className="object-cover w-full" /></div>
...
<ProductCard title="SwitchBot Smart Lock Premium Smart Upgrade" price="$139.99" link="https://amzn.to/4xkoZlI" rel="sponsored" />
...
<div className="my-8 rounded-lg overflow-hidden shadow-lg"><Image src="/Philips-Hue-Gradient-Signe-Floor-Lamp.webp" alt="Philips Hue Gradient Signe Smart Floor Lamp" width={1200} height={675} className="object-cover w-full" /></div>
...
<ProductCard title="Philips Hue Gradient Signe Smart Floor Lamp" price="$136.99" link="https://amzn.to/43PHDnM" rel="sponsored" />
*As an Amazon Associate, we earn from qualifying purchases.*
...
<div className="my-8 rounded-lg overflow-hidden shadow-lg"><Image src="/Ecobee-Smart-Thermostat-Premium.webp" alt="Ecobee Smart Thermostat Premium Zinc Design" width={1200} height={675} className="object-cover w-full" /></div>
...
<ProductCard title="Ecobee Smart Thermostat Premium" price="$199" link="https://amzn.to/4uVF2V9" rel="sponsored" />
*As an Amazon Associate, we earn from qualifying purchases.*
