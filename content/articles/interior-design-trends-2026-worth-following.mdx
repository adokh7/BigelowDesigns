...
<ShopTheLook>
  <ProductCard 
    title="Terracotta Rust Throw Blanket" 
    brand="Earthy Color Trend"
    image="/product-terracotta-rust-throw-blanket.webp"
    cta={{ label: "Check Price on Amazon", href: "https://amzn.to/43TkiSj" }}
  />
  <ProductCard 
    title="Vintage Brass Bankers Desk Lamp" 
    brand="Warm Metals Trend"
    image="/product-vintage-brass-bankers-desk-lamp.webp"
    cta={{ label: "Check Price on Amazon", href: "https://amzn.to/4f4U7OM" }}
  />
  <ProductCard 
    title="Antique Victorian Gold Bronze Picture Frame" 
    brand="Modern Heritage Trend"
    image="/product-antique-victorian-gold-bronze-frame.webp"
    cta={{ label: "Check Price on Amazon", href: "https://amzn.to/3T2nEju" }}
  />
</ShopTheLook>
