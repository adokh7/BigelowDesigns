  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'display-xl': ['48px', { lineHeight: '56px', letterSpacing: '-0.03em',  fontWeight: '500' }],
        'display-lg': ['40px', { lineHeight: '48px', letterSpacing: '-0.025em', fontWeight: '500' }],
        'h1':         ['34px', { lineHeight: '42px', letterSpacing: '-0.02em',  fontWeight: '600' }],
        'h2':         ['26px', { lineHeight: '34px', letterSpacing: '-0.015em', fontWeight: '600' }],
