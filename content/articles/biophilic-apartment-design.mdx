...
<AffiliateProductGrid
  heading="Get The Biophilic Look"
  caption="Three pieces to bring sophisticated nature-led design into a small apartment — no jungle required."
  products={[
  {
    name: "Hand-Thrown Stoneware Vase",
    brand: "Studio Aoba",
    description: "Wheel-thrown matte stoneware in soft clay tones — the perfect sculptural anchor for a single olive branch.",
    image: "/biophilic-apartment.webp",
    imageAlt: "A hand-thrown stoneware vase styled with a single olive branch",
    price: { amount: 84, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CSTONEVASE?tag=bigelow-20",
    network: "amazon",
    badge: "Editor's Pick",
  },
  {
    name: "96-inch Linen Window Sheers (Pair)",
    brand: "Quince",
    description: "Heavyweight Belgian linen that filters light like cathedral glass — softens harsh urban exposure.",
    image: "/bedroom-curtains.webp",
    imageAlt: "Floor-length natural linen window sheers in soft afternoon light",
    price: { amount: 129, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CLINENSHEERS?tag=bigelow-20",
    network: "amazon",
  },
  {
    name: "Self-Watering Snake Plant",
    brand: "The Sill",
    description: "Mature Sansevieria Laurentii in a terracotta self-watering planter — survives travel, low light, and forgetting.",
    image: "/biophilic-design.webp",
    imageAlt: "A mature snake plant in a terracotta self-watering planter",
    price: { amount: 68, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CSNAKEPLANT?tag=bigelow-20",
    network: "amazon",
  }
  ]}
/>
