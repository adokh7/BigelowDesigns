...
<AffiliateProductGrid
  heading="Build Your Balcony Oasis"
  caption="Three pieces to turn a forgettable concrete slab into the small Mediterranean retreat you actually use."
  products={[
  {
    name: "Teak Folding Bistro Set (Table + 2 Chairs)",
    brand: "Skagerak",
    description: "Solid teak that weathers gracefully — folds flat against the railing when the weather turns.",
    image: "/outdoor-balcony-oasis.webp",
    imageAlt: "A solid teak folding bistro set with two chairs and a small round table",
    price: { amount: 1195, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CTEAKBISTRO?tag=bigelow-20",
    network: "amazon",
    badge: "Editor's Pick",
  },
  {
    name: "Mature Olive Tree in Terracotta Planter",
    brand: "Patch Plants",
    description: "A four-foot Olea europaea in a hand-thrown terracotta planter — the Mediterranean instant-mood-shift in one shipment.",
    image: "/tiny-balcony-oasis.webp",
    imageAlt: "A mature olive tree in a hand-thrown terracotta planter",
    price: { amount: 385, currency: "USD" },
    href: "https://www.amazon.com/dp/B0COLIVETREE?tag=bigelow-20",
    network: "amazon",
  },
  {
    name: "Solar Café String Lights (35 ft)",
    brand: "Brightech",
    description: "Warm-white Edison bulbs with a solar panel — the warm overhead canopy that defines outdoor evenings.",
    image: "/outdoor-balcony-oasis.webp",
    imageAlt: "Solar-powered Edison café string lights strung overhead on a balcony",
    price: { amount: 94, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CSOLARLIGHTS?tag=bigelow-20",
    network: "amazon",
  }
  ]}
/>
