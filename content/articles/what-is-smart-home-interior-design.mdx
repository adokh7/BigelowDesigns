...
<div className="my-8 rounded-lg overflow-hidden shadow-lg"><Image src="/switchboot.webp" alt="SwitchBot Smart Lock Premium Home Integration" width={1200} height={675} className="object-cover w-full" /></div>
...
<ProductCard title="SwitchBot Smart Lock Premium Smart Upgrade" price="$139.99" link="https://amzn.to/3X7u7Xb" rel="sponsored" />
...
<div className="my-8 rounded-lg overflow-hidden shadow-lg"><Image src="/philips-hue-gardien.webp" alt="Philips Hue Gradient Signe Smart Floor Lamp" width={1200} height={675} className="object-cover w-full" /></div>
...
<div className="my-8 rounded-lg overflow-hidden shadow-lg"><Image src="/ecobee-smart-ther.webp" alt="Ecobee Smart Thermostat Premium Zinc Design" width={1200} height={675} className="object-cover w-full" /></div>
...
<ProductCard title="Ecobee Smart Thermostat Premium" price="$79.99" link="https://amzn.to/4esVo1J" rel="sponsored" />
*As an Amazon Associate, we earn from qualifying purchases.*
