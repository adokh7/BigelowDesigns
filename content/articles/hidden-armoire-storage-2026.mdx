...
<AffiliateProductGrid
  heading="Shop The Concealed Storage Edit"
  caption="Three pieces that hide the clutter without sacrificing the patina of a well-considered home."
  products={[
  {
    name: "Fluted Oak Tall Armoire",
    brand: "Crate & Barrel",
    description: "Solid white oak with hand-fluted door fronts, soft-close hinges, and an adjustable interior shelving system.",
    image: "/hidden-armoire-storage.webp",
    imageAlt: "A fluted oak armoire with vertical reeded door panels",
    price: { amount: 2499, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CFLUTEDARMOIRE?tag=bigelow-20",
    network: "amazon",
    badge: "Editor's Pick",
  },
  {
    name: "Unlacquered Brass Cabinet Pulls (Set of 6)",
    brand: "Rejuvenation",
    description: "Solid forged brass pulls that develop a living patina — instantly upgrades any flat-front cabinet.",
    image: "/brass-faucet-detail.webp",
    imageAlt: "A set of unlacquered brass cabinet pulls with hand-finished edges",
    price: { amount: 148, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CBRASSPULLS?tag=bigelow-20",
    network: "amazon",
  },
  {
    name: "Modular Walnut Drawer Organizer Set",
    brand: "Open Spaces",
    description: "Six interlocking walnut trays sized to subdivide any standard drawer — for cables, jewellery, or office sundries.",
    image: "/japandi-bedroom.webp",
    imageAlt: "A modular walnut drawer organizer with six interlocking trays",
    price: { amount: 96, currency: "USD" },
    href: "https://www.amazon.com/dp/B0CWALNUTORG?tag=bigelow-20",
    network: "amazon",
  }
  ]}
/>
